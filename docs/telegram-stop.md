...
- Sans requête en cours : « ⚪ Aucune requête Codex en cours. » ou « ⚪ Aucune requête Antigravity en cours. »
  selon le backend actif. La session et son processus au repos sont conservés.
